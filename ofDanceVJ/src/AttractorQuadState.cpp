...
//--------------------------------------------------------------
string AttractorQuadState::getName() {
	return "AttractorQuad";
}


//--------------------------------------------------------------
void AttractorQuadState::setup() {
	...
	gui.loadFromFile("gui_AttractorQuad.xml");
...
//--------------------------------------------------------------
void AttractorQuadState::stateExit() {

	gui.saveToFile("gui_AttractorQuad.xml");

}
//--------------------------------------------------------------
AttractorQuadState::~AttractorQuadState() {
...
//--------------------------------------------------------------
void AttractorQuadState::update() {
...
//--------------------------------------------------------------
void AttractorQuadState::keyPressed(int key) {
